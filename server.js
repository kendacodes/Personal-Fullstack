...
var ObjectId = require('mongodb').ObjectId;// defining the object id constructor
...
mongoose.connect(configDB.url, (err, database) => {
  ...
  db = database
  require('./app/routes.js')(app, passport, db, ObjectId);//passing ObjectId through our routes
